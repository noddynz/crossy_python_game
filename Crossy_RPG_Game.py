...
class Game:
    ...
    # Initialiser for the game class to set up the width, height, and title
...
class PlayerCharacter(GameObject):
    ...
    def detect_collision(self, entity):
        if self.y_pos > entity.y_pos + entity.height:
            return False
        elif self.y_pos + self.height < entity.y_pos:
            return False

        if self.x_pos > entity.x_pos + entity.width:
            return False
        elif self.x_pos + self.width < entity.x_pos:
            return False
